  ...
  head: () => ({
    meta: [
      ...
      { title: "Nova — AI Cohort Interview Agent" },
      {
        name: "description",
        content:
          "Adaptive AI technical interviews built from each learner's 31-day AI Cohort journey, with structured feedback at the end.",
      },
      { name: "author", content: "AI Cohort" },
      { property: "og:title", content: "Nova — AI Cohort Interview Agent" },
      {
        property: "og:description",
        content: "Adaptive, multi-turn AI technical interviews with structured feedback.",
      },
